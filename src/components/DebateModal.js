                    ...
                    { isParticipant && (
                        <div className="q-container">
                            <div className="question-box one">
                                ...
                                <p className="number" data-tip="Click to see cool facts and unique questions to discuss" onClick={ () => this.handleQuestionClick(1) }>1</p>
                    <ReactTooltip place="top" type="dark" effect="float"/>
                            </div>
                            <div className="question-box two">
                                <p className="number" data-tip="Click to see cool facts and unique questions to discuss" onClick={ () => this.handleQuestionClick(2) }>2</p>
                                <ReactTooltip place="top" type="dark" effect="float"/>
                            </div>
                            <div className="question-box three">
                                <p className="number" data-tip="Click to see cool facts and unique questions to discuss" onClick={ () => this.handleQuestionClick(3) }>3</p>
                                <ReactTooltip place="top" type="dark" effect="float"/>
                            </div>
                        </div>
                    )}
